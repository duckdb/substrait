...
@pytest.mark.skip(reason="Ibis Consumption: '*'")
def test_query_substrait_ibis_to_duck_01(require):
    execute_substrait_ibis_to_duck(require,1)
    
@pytest.mark.skip(reason="Ibis Consumption: pop from an empty deque")
...
@pytest.mark.skip(reason="Ibis Consumption: 'is_not_distinct_from'")
...
@pytest.mark.skip(reason="Ibis Consumption: Arguments with datatype !int32 and !string are not comparable")
def test_query_substrait_ibis_to_duck_07(require):
    execute_substrait_ibis_to_duck(require,7)

@pytest.mark.skip(reason="Ibis Consumption: Arguments with datatype !string and !int32 are not comparable")
def test_query_substrait_ibis_to_duck_08(require):
    execute_substrait_ibis_to_duck(require,8)

@pytest.mark.skip(reason="ValueError: Ibis Consumption: pop from an empty deque")
...
@pytest.mark.skip(reason="Arguments with datatype !int32 and string are not comparable")
